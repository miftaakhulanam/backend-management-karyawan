...
@section('container')
    <main class="flex h-screen justify-center items-center overflow-x-hidden overflow-y-auto p-10 bg-gray-200">
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum cumque illo hic similique cum in dolore architecto
            dolorum, corrupti voluptates minima quis enim modi qui laborum voluptatum optio possimus nostrum!</p>
