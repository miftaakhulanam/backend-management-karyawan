<div class="px-3 py-0 sm:px-10">
    <div class="flex items-center justify-between">
        <div class="flex items-center justify-center">
            ...
            <a href="/" class="flex w-36 sm:w-44 justify-center">
            ...
            <div class="flex items-center ms-3">
                <div>
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                        ...
                        type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" class="hidden sm:block m-0 sm:me-2" height="17"
                            width="17  " viewBox="0 0 448 512">
                            <path
                                d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
                        </svg>
                        <p class="line-clamp-1 w-20 sm:w-full">{{ auth()->user()->email }}</p>
                    ...
                    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-60">
                        <ul class="font-medium text-md text-gray-700" aria-labelledby="dropdownDefaultButton">
                            <a href="/profile"
