        ...
        <section class="flex justify-start items-center mt-3">
            <div class="relative">
                <div class="flex relative justify-center px-0 md:px-10 py-5 md:py-10 w-full md:w-[720px]">
                    <form method="POST"
                        action="{{ auth()->user()->is_admin == 'Admin' ? '/komplain/' . $komplain->id : '/komplain-staff/' . $komplain->id }}"
                        enctype="multipart/form-data" class="flex flex-col gap-2 w-full text-md font-bold">
                        @method('put')
                        @csrf
                        ...
                        <div class="flex justify-end gap-3">
                            <a href="{{ auth()->user()->is_admin == 'Admin' ? '/komplain' : '/komplain-staff' }}"
