...
@section('container')
    <main class="flex-1 min-h-screen px-4 py-8 md:p-10 mt-12 md:mt-14">
        ...
        <div class="flex justify-end">
            <form class="flex items-center w-full sm:w-fit mt-3 sm:mt-5">
            ...
            @else
                <table class="w-full table-auto text-sm">
                    ...
                    <tbody class="font-normal text-gray-700 text-center">
                        @foreach ($task as $t)
                            <tr class="py-5 md:py-10 bg-gray-100 hover:bg-gray-200 font-medium">
                                ...
                                <td class="pe-4 py-4">
                                    <div class="flex gap-3 justify-center">
                                        ...
                                        <a href="/monitoring-admin/{{ $t->id }}/edit">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    <div class="p-4 md:p-5 text-center">
                                                        ...
                                                        <div class="flex justify-center">
                                                            <form action="/monitoring-admin/{{ $t->id }}"
                                                                method="POST">
                                                                @method('delete')
                                                                @csrf
                                                                <button
