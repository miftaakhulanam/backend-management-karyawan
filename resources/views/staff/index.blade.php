                    ...
                    <tbody class="text-sm font-normal text-gray-700 text-center">
                        @foreach ($user as $u)
                            <tr class="py-10 bg-gray-100 hover:bg-gray-200 font-medium">
                                ...
                                <td class="px-4 py-4">{{ $u->phone }}</td>
                                <td class="px-4 py-4">{{ $u->jabatan }}</td>
                                <td class="px-4 py-4">{{ $u->is_admin }}</td>
                                <td class="px-4 py-4">
                                    <div class="flex gap-3 justify-center">
                                        ...
                                        <a href="/staff/{{ $u->id }}/edit">
                                            <svg class="h-6 fill-main" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 512 512">
                                                <path
                                        ...
                                        <button data-modal-target="popup-modal-delete-{{ $u->id }}"
                                            ...
                                            <svg class="h-6 fill-[#FF0000]" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512">
                                                <path
